...
@Component({
  ...
  template: `
    ...
    <aside
      ...
      class="w-64 bg-movtech-sidebar text-gray-200 flex flex-col overflow-y-auto
      ...
      <div class="px-4 py-4 border-b border-movtech-sidebar-light/60 hidden md:block">
        <div class="flex items-center gap-3">
          <div class="w-9 h-9 rounded bg-movtech-sidebar-active flex items-center justify-center font-bold text-white text-sm">M</div>
          <div>
            <div class="text-sm font-semibold text-white">Movtech</div>
      ...
      <nav class="flex-1 py-3 text-sm">
        <a class="flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-movtech-sidebar-hover cursor-default opacity-70">
        ...
        <a routerLink="/clientes"
           routerLinkActive="bg-movtech-sidebar-active border-l-[3px] border-blue-400 text-white"
           [routerLinkActiveOptions]="{ exact: false }"
           (click)="layout.closeMobileMenu()"
           class="flex items-center gap-3 px-4 py-2 text-gray-300 hover:bg-movtech-sidebar-hover border-l-[3px] border-transparent">
      ...
      <div class="p-4 border-t border-movtech-sidebar-light/60 text-[11px] text-gray-500">
